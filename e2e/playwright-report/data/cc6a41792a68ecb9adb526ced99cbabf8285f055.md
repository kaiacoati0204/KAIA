...
- Name: acessibilidade.spec.js >> acessibilidade WCAG 2 A/AA (axe): /pages/termos.html
- Location: tests\acessibilidade.spec.js:22:3

# Error details

```
Error: Violações de acessibilidade em /pages/termos.html:
...
+             Texto provisório — pendente de revisão jurídica. Será substituído pela
...
- article [ref=e2]:
  - link "← Voltar ao cadastro" [ref=e3] [cursor=pointer]:
    - /url: cadastro.html
  - heading "Termos de Uso" [level=1] [ref=e4]
  - paragraph [ref=e5]: Texto provisório — pendente de revisão jurídica. Será substituído pela versão final antes do lançamento.
  - heading "1. Sobre a KaIA" [level=2] [ref=e6]
  - paragraph [ref=e7]: A KaIA é uma plataforma de estudos para o Ensino Médio (ENEM e vestibulares), voltada ao foco e ao aprendizado ativo.
  - heading "2. Uso da conta" [level=2] [ref=e8]
  - paragraph [ref=e9]: Ao criar uma conta, você se compromete a fornecer informações verdadeiras e a manter suas credenciais em segurança. A conta é pessoal e intransferível.
  - heading "3. Público de menores" [level=2] [ref=e10]
  - paragraph [ref=e11]: Parte dos usuários é menor de idade. O uso por menores pressupõe ciência e concordância dos responsáveis, nos termos da política de privacidade.
  - heading "4. Conduta" [level=2] [ref=e12]
  - paragraph [ref=e13]: É esperado o uso da plataforma para fins de estudo. Usos que prejudiquem o serviço ou outros usuários podem levar à suspensão da conta.
  - heading "5. Alterações" [level=2] [ref=e14]
  - paragraph [ref=e15]: Estes termos podem ser atualizados. Mudanças relevantes serão comunicadas, e a versão aceita fica registrada na sua conta.
```
